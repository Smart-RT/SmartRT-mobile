...
class Routes {
  static Route<dynamic> Function(RouteSettings) generateRoute =
    ...
    switch (settings.name) {
      ...
      case DataWargaPage.id:
        return MaterialPageRoute(builder: (context) {
          return const DataWargaPage();
        });
      case DataWargaDetailPage.id:
        return MaterialPageRoute(builder: (context) {
          return DataWargaDetailPage(
            args: settings.arguments as DataWargaDetailPageArguments,
          );
        });
      case KonfirmasiRequestJabatan.id:
        return MaterialPageRoute(builder: (context) {
          return const KonfirmasiRequestJabatan();
        });
      ...
      case RiwayatTransaksiWilayah.id:
        return MaterialPageRoute(builder: (context) {
          return RiwayatTransaksiWilayah();
        });
      case RiwayatTransaksiKu.id:
        return MaterialPageRoute(builder: (context) {
          return RiwayatTransaksiKu();
        });
      case TagihanSayaPage.id:
        return MaterialPageRoute(builder: (context) {
          return TagihanSayaPage();
        });
      case TagihanSayaPageDetail.id:
        return MaterialPageRoute(builder: (context) {
          return TagihanSayaPageDetail(
              args: settings.arguments as TagihanSayaPageDetailArguments);
        });
